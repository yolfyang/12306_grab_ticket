...
class submitOrderRequest:
    ...
    def sendSubmitOrderRequest(self):
        ...
        submitResult = self.session.httpClient.send(submit_station_url, self.data_apr())
...
class submitOrderRequestByAfterNate:
    ...
    def sendSubmitOrderRequest(self, ):
        submitOrderRequestRsp = self.session.httpClient.send(urls.get("SubmitOrderRequestRsp"), self.data_apr())
