...
class Query:
    ...
    def __init__(self, select_obj, from_station, to_station, from_station_h, to_station_h, _station_seat, station_trains,
    ...
    def send_query(self):
        ...
        if TickerConfig.IS_CDN == 1 and self.session.cdn_list:
            self.httpClient.cdn = self.session.cdn_list[random.randint(4, len(self.session.cdn_list) - 1)]
        ...
        return {"code": Ticket.FAIL_CODE, "status": False, "cdn": self.httpClient.cdn, }
