...
class TestAll(unittest.TestCase):
    ...
    def testServerChan(self):
        ...
        :return:
        """
        send_server_chan(u"server酱 微信通知测试一下")
    ...
    def testVerfyImage(self):
        ...
        with open('../tkcode.png', 'rb') as f:
            ...
            for i in range(5):
                t = threading.Thread(target=v.verify, args=(base64_image,))
                t.start()
    ...
    def testCdn(self):
        ...
        s = Select()
        s.httpClient.cdn = cdn[3]
        get_drvices_id(s)
        LeftTicketInit(s).req_left_ticket_init()
